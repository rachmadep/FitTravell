...
<head>
    ...
    <title>@yield('title') - AdminFitTravel</title>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="/adm/tour">
                                <i class="fas fa-camera"></i>Tours</a>
                        </li>
                        <li>
                            <a href="/adm/order">
                        ...
                        <li>
                            <a href="/adm/ordercompleted">
                                <i class="fas fa-check-square"></i>Orders Completed</a>
                        </li>
                        <li>
                            <a href="/adm/salehistory">
                                <i class="fas fa-line-chart"></i>Sales History</a>
                        </li>
                    </ul>
                </div>
            </nav>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="/admin/images/user/ava-admin.png" alt="{{ $user -> name }}" />
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="/admin/images/user/ava-admin.png" alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
